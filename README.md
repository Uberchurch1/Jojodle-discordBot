...
To set up the token you will have to make use of the [`.env.example`](.env) file, you should rename it to `.env` and replace `YOUR_BOT_TOKEN_HERE` with your actual bot's token.
